...
\begin{enumerate}
  ...
  \item
        Factorize the resulting block-tri-diagonal into a lower bi-diagonal block matrix, a diagonal block matrix and an upper block-diagonal
        matrix (the LDU factorization).
