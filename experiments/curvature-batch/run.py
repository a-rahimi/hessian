"""Run the curvature-batch experiment and write results/<name>.csv per config.

    python experiments/curvature-batch/run.py                    # every config
    python experiments/curvature-batch/run.py gelu_seed0_fresh   # one by name
